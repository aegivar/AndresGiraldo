public class BankAdvisor {
    ...
    public void withdrawal(Costumer costumer,long initialTime){
        ...
        System.out.println(" The Bank Advisor " +this.name + " has finished to process "+ costumer.getName() +", Time:" +((System.currentTimeMillis() - initialTime)/1000) + " Seconds");
    }
